...
#ifdef __ANDROID__
    // The desktop GL renderer stores a projected-light texture in shader
    // objects.  Android's Vulkan backend owns shader/material creation, so
    // retain the authored texture name on the light itself instead.
