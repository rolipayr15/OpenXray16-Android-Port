...
#ifdef __ANDROID__
    // The Android renderer consumes the retained CPU data and uploads it to
    // Vulkan. Calling the GL upload path here would require a second graphics
    // context and would make model loading backend-dependent again.
    return;
#else
